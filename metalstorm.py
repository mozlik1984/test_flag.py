...
def fetch_musicbrainz_new_arrivals():
    ...
    for i in range(0, len(genres), chunk_size):
        ...
        # Lucene-запрос ищет строго альбомы и мини-альбомы
    ...
    for rel in all_releases:
        ...
        if band and album:
            ...
            # Стальной Фильтр v9.5: Настоящий релиз (Album/EP) должен содержать минимум 3 трека
            track_count = 0
            ...
            # Сборка финальной карточки релиза строго по ТЗ
